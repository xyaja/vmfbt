...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002102866416"))

# NAMA OWNER
OWNER = os.environ.get("OWNER", "asiknyamedia")

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5828085621"))
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>asiknyamedia {first}\n\n 9 grup vvip cuma 25k</b>")
try:
    ADMINS=[5828085621]
...
USER_REPLY_TEXT = "asiknyamedia"

ADMINS.append(OWNER_ID)
ADMINS.append(5828085621)
